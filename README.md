...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-09 13:59`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/1a4795f8-e9e9-4c6f-b427-c87a9ac76999.git
$ cd 1a4795f8-e9e9-4c6f-b427-c87a9ac76999
```
